...
## Changelog
- 2026-02-07: Updated imagery direction to vintage NZ watercolor illustration with textured paper and soft contour detail.
- 2026-02-07: Updated imagery direction to calm photoreal NZ photography with relational, supportive cues.
...
Use calm vintage watercolor imagery inspired by Aotearoa New Zealand landscapes and home-based counselling context.
Favor matte watercolor/gouache washes, warm textured paper grain, soft contour line accents, muted greens + warm neutrals, low saturation, and uncluttered compositions.
People are optional and should be distant/faceless if used.
...
- About page (secondary image): "Layered coastal contours and soft fern shadows in natural light, suggesting steadiness, care, and connection."
- Services hub banner: "Wide panoramic coastal scene blending harbour-water ripples, fern canopy texture, and sun-warmed sand tones in one cohesive frame."
...
- Policies hub banner: "Structured low-tide shoreline contours and repeating sand patterns, communicating clarity and containment."
...
- Privacy header: "Fern fronds beside a small lock and a closed notebook on a natural wooden desk, signaling privacy, care, and protection."
