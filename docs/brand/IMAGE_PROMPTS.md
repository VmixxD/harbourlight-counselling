...
Purpose: Provide a single, consistent watercolor illustration prompt system and per-image add-ons for
...
"{SUBJECT}. Calm vintage watercolor illustration inspired by Aotearoa New Zealand landscapes,
matte watercolor and gouache washes on warm textured paper, delicate pencil-and-ink contour accents,
muted sage/moss/olive/clay palette on warm cream, low saturation, low contrast, soft atmospheric haze,
spacious composition with breathing room for text overlays, emotionally supportive and grounded."

## Optional style modifiers (use only if needed)
- gentle mist layers and soft distance fade
- deckled paper-edge vignette (subtle)
- fine botanical linework around foliage edges
- shallow water ripple linework in foreground
- warm cream paper grain and matte finish
- paired natural elements suggesting connection and support
...
## Output guidance
- Palette: sage, moss, olive, warm cream, clay, soft sand. Keep saturation low.
...
- Keep brush edges soft and paper texture visible but not overpowering.
...
Optional modifiers: gentle mist layers and soft distance fade, open negative space on one side for copy

`public/images/hlc-home-hero-bush-trail.png`
Page usage: `app/page.tsx` (home "This might be for you")
Aspect ratio: 3:4 portrait
Add-on subject: "Native NZ bush trail after light rain, fern-lined edges, filtered light through canopy, and a gentle sense of forward movement"
Optional modifiers: fine botanical linework around foliage edges, warm cream paper grain and matte finish

`public/images/hlc-about-abstract-shapes.png`
Page usage: `app/about/page.tsx`
Aspect ratio: 1:1 square
Add-on subject: "Layered riverbank contours, soft fern silhouettes, and calm tonal overlap suggesting steadiness, care, and connection"
Optional modifiers: deckled paper-edge vignette (subtle), warm cream paper grain and matte finish
...
Add-on subject: "Panoramic triptych-style scene blending harbour-water texture, fern canopy forms, and sun-warmed shoreline tones into one cohesive strip"
Optional modifiers: shallow water ripple linework in foreground, gentle mist layers and soft distance fade
...
Optional modifiers: fine botanical linework around foliage edges, open negative space on one side for copy
...
Optional modifiers: paired natural elements suggesting connection and support, shallow water ripple linework in foreground

`public/images/hlc-service-burnout-clearing.png`
Page usage: `app/services/[slug]/page.tsx` (Burnout & Work Stress hero)
Aspect ratio: 3:4 portrait
Add-on subject: "Quiet forest clearing with filtered light, a resting place, and a soft path leading onward to suggest recovery and steadier rhythm"
Optional modifiers: gentle mist layers and soft distance fade, open negative space on one side for copy
...
Optional modifiers: warm cream paper grain and matte finish, deckled paper-edge vignette (subtle)
...
Aspect ratio: wide panorama (target 4:1 to 5:1)
Add-on subject: "Structured but soft shoreline contours and layered natural forms, communicating clarity and containment"
Optional modifiers: deckled paper-edge vignette (subtle), warm cream paper grain and matte finish

`public/images/hlc-policy-privacy-leaf-lock.png`
Page usage: `app/policies/privacy/page.tsx` (PageHeader image)
Aspect ratio: 3:4 portrait
Add-on subject: "Fern fronds beside a small lock and closed notebook on a natural desk, signaling privacy, care, and protection"
Optional modifiers: fine botanical linework around foliage edges, open negative space on one side for copy
...
Optional modifiers: warm cream paper grain and matte finish, open negative space on one side for copy
...
Optional modifiers: gentle mist layers and soft distance fade, shallow water ripple linework in foreground
