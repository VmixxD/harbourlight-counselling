  ...
  return (
    <>
      <PageHeader
        ...
        intro="Choose the option that feels easiest. A free consult is a gentle first step."
        ...
        <Container className="space-y-10">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-sage/50 bg-white/80 p-6 shadow-soft">
              <p className="text-xs uppercase tracking-[0.25em] text-forest/60">Option 1</p>
            ...
            <div className="rounded-2xl border border-sage/50 bg-white/80 p-6 shadow-soft">
              <p className="text-xs uppercase tracking-[0.25em] text-forest/60">Option 2</p>
